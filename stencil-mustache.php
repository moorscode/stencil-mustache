...
Description: Stencil Implementation. This addon enables the use of Mustache in your theme. This addon requires the plugin Stencil to be installed and activated.
Version: 1.0.0
Author: jipmoors
